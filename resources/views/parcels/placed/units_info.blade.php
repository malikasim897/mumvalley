                        ...
                        <div class="bs-stepper-content">
                            <div id="sender-details">
                                ...
                                <form id="orderDetailsForm"
                                    action="{{ route('product.order.details.store', $product->id) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-3" style="min-height: 85px;">
                                            ...
                                            <input type="text" name="remaining_quantity" id="remaining_quantity" class="form-control form-control-sm"
                                                placeholder="" value="{{ optional(optional($product)->latestconfirmedinventory)->remaining_units }}" readonly/>
                                        ...
                                        <div class="mb-1 col-md-3">
                                            <label class="form-label" for="shipped_units">Units to be Shipped?<span
                                                    class="text-danger">*</span></label>
                                            <input type="number" name="shipped_units" id="shipped_units" class="form-control form-control-sm" value="{{ old('shipped_units') }}" required oninput="calculateRemainingUnits()"/>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-2" id="fnsku_quantity_div" style="display:none;">
                                            ...
                                            <input type="number" name="fnsku_quantity" id="fnsku_quantity" class="form-control form-control-sm" value="{{ old('fnsku_quantity') }}" />
                                        ...
                                        <div class="mb-1 col-md-2" id="bubblewrap_quantity_div" style="display:none;">
                                            ...
                                            <input type="number" name="bubblewrap_quantity" id="bubblewrap_quantity" class="form-control form-control-sm" value="{{ old('bubblewrap_quantity') }}" />
                                        ...
                                        <div class="mb-1 col-md-2" id="polybag_quantity_div" style="display:none;">
                                            ...
                                            <input type="number" name="polybag_quantity" id="polybag_quantity" class="form-control form-control-sm" value="{{ old('polybag_quantity') }}" />
                                        ...
                                        <div class="mb-1 col-md-2" id="small_box_quantity_div" style="display:none;">
                                            ...
                                            <input type="number" name="small_box_quantity" id="small_box_quantity" class="form-control form-control-sm" value="{{ old('small_box_quantity') }}" />
                                        ...
                                        <div class="mb-1 col-md-2" id="medium_box_quantity_div" style="display:none;">
                                            ...
                                            <input type="number" name="medium_box_quantity" id="medium_box_quantity" class="form-control form-control-sm" value="{{ old('medium_box_quantity') }}" />
                                        ...
                                        <div class="mb-1 col-md-2" id="large_box_quantity_div" style="display:none;">
                                            ...
                                            <input type="number" name="large_box_quantity" id="large_box_quantity" class="form-control form-control-sm" value="{{ old('large_box_quantity') }}" />
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-2" id="additional_units_quantity_div" style="display:none;">
                                            ...
                                            <input type="number" name="additional_units_quantity" id="additional_units_quantity" class="form-control form-control-sm" value="{{ old('additional_units_quantity') }}" />
                                    ...
                                    <div class="row mt-1 mb-1">
                                        <div class="mb-1 col-md-3">
                                            <label for="fnsku" class="d-flex align-items-center">
                                                <input type="checkbox" name="fnsku" id="fnsku" value="1" {{ old('fnsku') ? 'checked' : '' }} />
                                        ...
                                        <div class="mb-1 col-md-3">
                                            <label for="bubblewrap" class="d-flex align-items-center">
                                                <input type="checkbox" name="bubblewrap" id="bubblewrap" value="1" {{ old('bubblewrap') ? 'checked' : '' }} />
                                                <span class="custom-checkbox"></span>
                                        ...
                                        <div class="mb-1 col-md-3">
                                            <label for="polybag" class="d-flex align-items-center">
                                                <input type="checkbox" name="polybag" id="polybag" value="1" {{ old('polybag') ? 'checked' : '' }} />
                                                <span class="custom-checkbox"></span>
                                        ...
                                        <div class="mb-1 col-md-3">
                                            <label for="small_box" class="d-flex align-items-center">
                                                <input type="checkbox" name="small_box" id="small_box" value="1" {{ old('small_box') ? 'checked' : '' }} />
                                                <span class="custom-checkbox"></span>
                                        ...
                                        <div class="mb-1 col-md-3">
                                            <label for="medium_box" class="d-flex align-items-center">
                                                <input type="checkbox" name="medium_box" id="medium_box" value="1" {{ old('medium_box') ? 'checked' : '' }} />
                                                <span class="custom-checkbox"></span>
                                        ...
                                        <div class="mb-1 col-md-3">
                                            <label for="large_box" class="d-flex align-items-center">
                                                <input type="checkbox" name="large_box" id="large_box" value="1" {{ old('large_box') ? 'checked' : '' }} />
                                                <span class="custom-checkbox"></span>
                                        ...
                                        <div class="mb-1 col-md-3">
                                            <label for="additional_units" class="d-flex align-items-center">
                                                <input type="checkbox" name="additional_units" id="additional_units" value="1" {{ old('additional_units') ? 'checked' : '' }} />
                                                <span class="custom-checkbox"></span>
