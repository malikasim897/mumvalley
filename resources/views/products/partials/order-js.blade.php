<script>
    $(document).ready(function() {
        ...
        $('#senderCountry').on('change', function() {
            ...
            if (selectedCountryId) {
                ...
                $.ajax({
                    url: "{{ route('parcel.country.states', ['countryId' => ':countryId']) }}"
        ...
        if (selectedStateId == '') {
            if (selectedCountryId) {
                $.ajax({
                    url: "{{ route('parcel.country.states', ['countryId' => ':countryId']) }}".replace(
        ...
        //     var orderId = '{{ $parcel->id }}';
        //     var data = {
        //         country_id: country_id,
        //         state_id: state_id
        //     };
        // $.ajax({
        //     url: "{{ route('parcel.services.rates', ['orderId' => ':orderId']) }}".replace(':orderId', orderId),
        //     type: 'GET',
        //     dataType: 'json',
        //     data: data,
    ...
    function getServicesWithRates() {
        ...
        var country_id = '{{ $parcel->customerRecipientDetails->country_id ?? '' }}';
        var state_id = '{{ $parcel->customerRecipientDetails->state_id ?? '' }}';
        var orderId = '{{ $parcel->id }}';
        var data = {
            country_id: country_id,
            state_id: state_id
        ...
        $.ajax({
            url: "{{ route('parcel.services.rates', ['orderId' => ':orderId']) }}".replace(':orderId',
                orderId),
            type: 'GET',
            dataType: 'json',
            data: data,
