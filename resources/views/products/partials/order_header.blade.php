...
<div class="bs-stepper-header" role="tablist">
    <div class="step {{ Route::currentRouteName() == 'parcel.sender.details' ? 'active' : '' }}">
        <button type="button" class="step-trigger">
            <span class="bs-stepper-box">1</span>
            <span class="bs-stepper-label">
                <span class="bs-stepper-title">Sender Details</span>
            </span>
        </button>
    </div>
    <div class="line">
    ...
    <div class="step {{ Route::currentRouteName() == 'parcel.invoice.details' ? 'active' : '' }}" data-target="#invoice" role="tab" id="Invoice-trigger">
        <button type="button" class="step-trigger">
