            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Edit Permissions</h2>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-check form-switch form-check-primary">
                                                            <input name="permissions[]" type="checkbox" class="form-check-input permissionCheckbox" id="customSwitch{{$module}}{{$key}}"  value="{{ $permission->name }}" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }} id="customSwitch{{$key}}">
                                                        ...
                                                        {{-- <div class="form-check form-check-primary form-switch">
                                                            <input name="permissions[]" type="checkbox" class="form-check-input" value="{{ $permission->name }}"  {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }} id="customSwitch{{$key}}">
                                                        </div> --}}
