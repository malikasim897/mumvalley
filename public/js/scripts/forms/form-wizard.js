...
$(function () {
  ...
  var bsStepper = document.querySelectorAll('.bs-stepper'),
    ...
    orderWizard = document.querySelector('.horizontal-order-wizard'),
  ...
  // order Wizard
  // --------------------------------------------------------------------
  if (typeof orderWizard !== undefined && orderWizard !== null) {
    var numberedStepper = new Stepper(orderWizard),
      $form = $(orderWizard).find('form');
    $form.each(function () {
      var $this = $(this);
      $this.validate({
        // rules: {
        ...
        //   },
        //   sender_phone: {
        //     pattern: "Please enter a valid international phone number format (e.g., +5511992230189)"
        //   },
        //   receiver_phone: {
        //       pattern: "Please enter 11 digit valid international phone number US format (e.g., +12025550160)"
        //   },
        //   description: {
        //     required: "Description is required.",
        //     minlength: "Description must be at least 4 characters long.",
        //     maxlength: "Description cannot exceed 40 characters."
        //   },
        //   shippment_value: {
        //     required: "Shipment value is required.",
        //     min: "Shipment value frieght must be greater than zero."
        //   }
        // }
      });
    });
