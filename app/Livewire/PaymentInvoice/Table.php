...
class Table extends Component
{
    ...
    public function getInvoices()
    {
        ...
        $result = (new PaymentInvoiceRepository)->get($parameters, true, $this->pageSize, $this->sortBy, $this->sortAsc ? 'asc' : 'desc');
        ...
        $this->partialPaidInvoices = $result['partialPaidInvoices'];
